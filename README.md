...
👩‍🏫 Teacher
Roll No: T001 Password: admin123 Role: Teacher

👨‍🎓 Students
Roll No: 101 – 110 Password: 1234 Role: Student
...
📂 Project Structure
College-Attendance-System/ │ ├── index.html # Login Page ├── teacher.html # Teacher Dashboard ├── student.html # Student Dashboard ├── style.css # Styling ├── script.js # Complete Logic └── README.md # Project Documentation
...
📤 Export Feature
Teacher can export attendance data in CSV format. The downloaded file includes:
